                ...
                <td width="81%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
					...
					<table width="94%" border="0" cellpadding="0" cellspacing="0" style="border:1px solid #550000;">
					 ...
					 $get_lppt = "select lft_pt,rght_pt,cmn_pair,lst_used_par from last_pp_detls where membr_id = '".$_SESSION['userid']."'";
					 ...
					 //}
					 $tot_last_pair = $get_lppt2['lst_used_par'];
						 ...
						 <!--<tr>
						   ...
						   <td align="left" valign="middle" style="color:#003366;"><strong>Used Point </strong></td>
						   <td height="34" align="center" valign="middle">-</td>
