...
if(isset($_REQUEST['submit']))
{
	...
	{
	  $rewardimg = $_POST['old_img'];
	}
	
	
	$insrewads = "update rewards_list set item_name = '".$_POST['itm_nme']."',
									      item_img = '".$rewardimg."',
									      pari_business = '".$_POST['pair_busins']."' where rid = '".$rid."'";
	$insrewards2 = mysql_query($insrewads) or die(mysql_error());										   
	header("location:rewards.php?msg=ups");
}
...
//get rewards details for edit
$sqlstr = "select * from rewards_list where rid = '".$rid."'";
                ...
                <!--  end step-holder -->
                  ...
                  <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
                    <tr>
                      ...
                      <td><input name="itm_nme" type="text" class="inp-form" id="itm_nme" value="<?php echo $result['item_name']; ?>"/></td>
                      <td></td>
                    </tr>
                    ...
                    <tr>
					  ...
					  <img src="reward_imgs/<?php echo $result['item_img']; ?>" border="0" width="53" height="54" />
					  <?php } ?>
					  </td>
                      <td></td>
                    </tr>
                    <tr>
                      ...
                      <td><input name="pair_busins" type="text" class="inp-form" id="pair_busins" value="<?php echo $result['pari_business']; ?>"/></td>
                      <td></td>
                    </tr>
                    <tr>
                      <th><input type="hidden" name="old_img" id="old_img" value="<?php echo $result['item_img']; ?>" /></th>
                      <td valign="top"><input name="submit" type="submit" class="form-submit" value="" /></td>
                      <td></td>
                    </tr>
                  </table>
                <!-- end id-form  -->
