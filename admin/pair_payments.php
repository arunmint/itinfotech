...
<div id="content">
  ...
  <tr>
    <td width="70%"><h1>Pair Payments</h1></td>
    <td width="15%">
	<?php
	  $csv_hdr = "User ID, User Name, Pair Points, Amount, Signature";
	?>
				...
				<?php
				$selstr = "select clsng_dt_id,membr_id,user_id,lft_pt,rght_pt,cmn_pair,par_pnt,par_amt from last_pp_detls where cmn_pair!= '0' and clsng_dt_id = '".$clsing_dmy."'";
				...
				?>  
				<tr>
				 <td><?php @$csv_output .= $result['user_id'] . ", "; ?></td>
				 <td><?php @$csv_output .= get_membername($result['user_id']) . ", "; ?></td>
				 <td><?php @$csv_output .= $result['par_pnt']  . ", "; ?></td>
				 <td><?php @$csv_output .= $result['par_amt']  . ", "; ?></td>
				 <td><?php @$csv_output .= " " . "\n"; ?></td>
				</tr>
		  <?php } ?>
     			</table>
