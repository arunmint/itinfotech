...
if(isset($_REQUEST['clntid']))
{
  $clntid = $_REQUEST['clntid'];
}

     echo $insclnt = "update client_list set usr_pswd = '".$_POST['pswd']."',
										...
										bnk_IFSC = '".$_POST['ifsc_code']."' where client_id = '".$clntid."'";
										
     $insclnt2 = mysql_query($insclnt) or die(mysql_error());
	 exit();
     header("location:thankyou.php?msg=suc");
?>